import { Component, ContentChild, ContentChildren, ElementRef, EventEmitter, HostBinding, Inject, Input, Optional, Output, Renderer2, QueryList, ViewChild, isDevMode, NgZone, ViewChildren, ChangeDetectorRef } from '@angular/core';
...
import { columnsToRender, expandColumns, isValidFieldName } from "./columns/column-common";
import { ScrollSyncService } from "./scrolling/scroll-sync.service";
import { ResizeService } from "./layout/resize.service";
import { closest, matchesClasses, matchesNodeName, findFocusable } from './rendering/common/dom-queries';
...
var GridComponent = (function () {
    function GridComponent(supportService, selectionService, wrapper, groupInfoService, groupsService, changeNotification, detailsService, editService, filterService, pdfService, responsiveService, renderer, excelService, ngZone, scrollSyncService, domEvents, rtl, columnResizingService, changeDetectorRef) {
         ...
         */
        this.selectionChange = new ZoneAwareEventEmitter(this.ngZone);
        /**
    ...
    GridComponent.prototype.columnsContainerChange = function () {
        ...
        this.columnsContainerChangeSubscription = this.columnsContainer.changes
            ...
            .filter(function () { return isPresent(_this.lockedHeader); })
            .subscribe(function () {
