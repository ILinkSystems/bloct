...
import { ViewChild, ViewContainerRef, Component, HostBinding, Input, Optional, Inject, Output, EventEmitter, isDevMode, forwardRef, ContentChild, ChangeDetectorRef, KeyValueDiffers } from '@angular/core';
...
var MultiSelectComponent = (function () {
    ...
    MultiSelectComponent.prototype.removeTag = function (dataItem) {
        ...
        if (isNumber(index)) {
            ...
            var filter = function (item) { return getter(item, _this.valueField) !== getter(dataItem, _this.valueField); };
    ...
    MultiSelectComponent.prototype.getSelectedDataItems = function (valueChanges) {
        ...
        valueChanges.forEachItem(function (value) {
            ...
            var isBoundToComplexData = isObjectArray(_this.data);
            var index = _this.data.findIndex(function (item) {
                var value = _this.valuePrimitive ? currentValue : getter(currentValue, _this.valueField);
                return getter(item, _this.valueField) === value;
            });
            if (index !== -1) {
