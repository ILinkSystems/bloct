...
import { Component, forwardRef, Input, Output, HostBinding, EventEmitter, ContentChild, ViewChild, ViewContainerRef, isDevMode, Optional, Inject, NgZone, ChangeDetectorRef } from '@angular/core';
...
(function (InternalState) {
    ...
    InternalState[InternalState["UseModel"] = 16] = "UseModel";
...
var DropDownListComponent = (function () {
    function DropDownListComponent(rtl, popupService, selectionService, navigationService, _zone, cdr) {
        ...
        this.disabled = false;
        /**
         * Enables the [filtering]({% slug filtering_ddl_kendouiforangular %}) functionality of the DropDownList.
         */
         ...
         *
         * For more details, refer to the example on [events]({% slug overview_ddl_kendouiforangular %}#toc-events).
         */
    ...
    DropDownListComponent.prototype.subscribeEvents = function () {
        ...
        this.filterBlurredSubscription = this.filterBlurred
            .concatMap(function () { return Observable.interval(10).take(1).takeUntil(_this.wrapperFocused); })
            .subscribe(function () {
    ...
    DropDownListComponent.prototype.change = function (dataItem) {
        ...
        //refactor!
        this._modelValue = this.valuePrimitive ? primitiveValue : this.value;
    ...
    DropDownListComponent.prototype.resolveState = function () {
        ...
        state |= this._state & InternalState.SetInitial | this._state & InternalState.UseInitial;
        this._state = state;
        return existing;
    };
    DropDownListComponent.prototype.setState = function () {
        ...
        if (this._state & InternalState.UseModel) {
            ...
            this.verifySettings(this._modelValue);
